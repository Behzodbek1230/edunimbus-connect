...
import { BookOpen, Lock, Mail, User, Phone, Eye, EyeOff } from "lucide-react";
...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setIsLoading(false);
      alert("Ro'yxatdan o'tish muvaffaqiyatli! (Mock)");
    }, 1000);
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.role} onValueChange={(value) => handleInputChange("role", value)}>
                  ...
                  <SelectContent>
                    <SelectItem value="center_admin">O'quv markazi egasi</SelectItem>
